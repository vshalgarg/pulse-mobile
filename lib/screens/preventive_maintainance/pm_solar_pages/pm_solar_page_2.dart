...
class _PmSolarPage2State extends State<PmSolarPage2> {
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildCivilStructuresSection(data),
                        getHeight(30),
  ...
  String _getSuccessMessage() {
    return 'Civil & Structures section data saved successfully!';
  }

  String _getCancelMessage() {
    return 'Civil & Structures section data cancelled!';
  }
