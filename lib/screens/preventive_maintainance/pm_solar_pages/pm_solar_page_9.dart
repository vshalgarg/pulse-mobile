...
class _PmSolarPage9State extends State<PmSolarPage9> {
  ...
  Widget _buildPerformanceMonitoringSection(PmGetDataModel data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildFormField('Check system performance metrics', 'DROPDOWN,IMG'),
        getHeight(15),
        _buildFormField('Check energy generation data', 'DROPDOWN,IMG'),
        getHeight(15),
        _buildFormField('Check system efficiency', 'DROPDOWN,IMG'),
        getHeight(15),
        _buildFormField('Check monitoring equipment status', 'DROPDOWN,IMG'),
        getHeight(15),
        _buildFormField('Check data logging system', 'DROPDOWN,IMG'),
      ],
    );
  }
