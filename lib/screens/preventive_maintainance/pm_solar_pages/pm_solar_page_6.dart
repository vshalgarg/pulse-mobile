...
class _PmSolarPage6State extends State<PmSolarPage6> {
              ...
              children: [
                ...
                ImageUploadField(
                  ...
                  onImageSelected: isEditable
                      ? (image) => _saveFormData('${key}_image', image)
                      : (image) {},
                  isRequired: true,
                ),
              ],
  ...
  void _handleNext() {
    // Navigate to next page - Inverters
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  String _getSuccessMessage() {
    return 'SPV section data saved successfully!';
  }

  String _getCancelMessage() {
    return 'SPV section data cancelled!';
  }
