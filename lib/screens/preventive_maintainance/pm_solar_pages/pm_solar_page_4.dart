...
class _PmSolarPage4State extends State<PmSolarPage4> {
  ...
  void _handleNext() {
    // Navigate to next page - Safety Systems
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  String _getSuccessMessage() {
    return 'Transformer section data saved successfully!';
  }

  String _getCancelMessage() {
    return 'Transformer section data cancelled!';
  }
