...
class _PmSolarPage5State extends State<PmSolarPage5> {
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildSafetySystemsSection(data),
                        getHeight(30),
  ...
  String _getSuccessMessage() {
    return 'Safety Systems section data saved successfully!';
  }

  String _getCancelMessage() {
    return 'Safety Systems section data cancelled!';
  }
