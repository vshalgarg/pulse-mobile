...
class _DgScreenState extends State<DgScreen> {
  ...
  void _loadImageForEdit(String photoId, String itemType) {
    ...
    print(
      'DG Screen: Loading image for edit - photoId: $photoId, itemType: $itemType',
    );
    ...
    // Use the existing cubit to get image
  ...
  void _navigateToSMPSScreen() {
    ...
    pushPage(
      ...
      SMPSScreen(
        ...
        // Don't show success message when skipping DG screen
  ...
  void _saveCCTVForm() {
    ...
    if (_isFormValid()) {
      setState(() {
        ...
        print(
          'DG Screen: Retrieved assetAuditSiteRespId: $assetAuditSiteRespId',
        );
        ...
        print(
          'DG Screen: Created form data with assetAuditSiteRespId: ${currentFormData['assetAuditSiteRespId']}',
        );
    ...
    try {
      ...
      if (generalRemarksController.text.isNotEmpty) {
        ...
        if (remarksAssetAuditSiteRespId != null) {
          ...
          print(
            'DG Screen: Added user remarks to post with ID: $remarksAssetAuditSiteRespId, text: "${generalRemarksController.text}"',
          );
        } else {
    ...
    return BlocListener<AssetAuditGetImageCubit, AssetAuditGetImageState>(
      listener: (context, state) {
        if (state is AssetAuditGetImageSuccess) {
          print('DG Screen: Image loaded successfully for ${_editingItemType}');
          setState(() {
            if (_editingItemType == 'cctv') {
              cctvPhoto = state.imageData;
            }
          ...
          print('DG Screen: Failed to load image: ${state.errorMessage}');
          setState(() {
            _isRequestingImage = false;
            _currentRequestedImageId = null;
            _editingItemType = null;
      ...
      child: BlocListener<AssetAuditCubit, AssetAuditState>(
        listener: (context, state) {
          ...
          if (state is AssetAuditPostSuccess) {
            ...
            bool isDGData = false;
            print(
              'DG Screen: Total responses received: ${state.responses.length}',
            );
            for (var response in state.responses) {
              print('DG Screen: Full response object: $response');
              print(
                'DG Screen: Checking response itemTypeRemark: ${response.itemTypeRemark}',
              );
              print(
                'DG Screen: Checking response itemTypeId: ${response.itemTypeId}',
              );
              print(
                'DG Screen: Checking response nexgenSerialNo: ${response.nexgenSerialNo}',
              );
              print(
                'DG Screen: Checking response assetStatus: ${response.assetStatus}',
              );
              print(
                'DG Screen: Checking response remarks: ${response.remarks}',
              );
              ...
              if (response.itemTypeRemark != null &&
                ...
                isDGData = true;
                print(
                  'DG Screen: Found DG-related item by itemTypeRemark: ${response.itemTypeRemark}',
                );
                break;
              }
              ...
              if (_hasPostedDGData) {
                isDGData = true;
                print(
                  'DG Screen: Found DG-related item by flag check (fallback)',
                );
                break;
              }

              print(
                'DG Screen: itemTypeRemark "${response.itemTypeRemark}" does not match DG patterns',
              );
            }
            ...
            if (isDGData) {
              print(
                'DG Screen: Confirmed this is DG screen data, proceeding with data refresh...',
              );
              ...
              try {
                ...
                Future.delayed(const Duration(seconds: 2), () {
                  if (mounted) {
                    print(
                      'DG Screen: Data refreshed, navigating to next screen...',
                    );
                    pushPage(
                      context,
                      SMPSScreen(
                    ...
                    print(
                      'DG Screen: Reset _hasPostedDGData flag to false after navigation',
                    );
                  }
                });
              } catch (e) {
              ...
              print(
                'DG Screen: Success state received but not for DG screen data, ignoring...',
              );
              print('DG Screen: _hasPostedDGData flag: $_hasPostedDGData');
            }
            ...
            if (_hasPostedDGData) {
              ...
              showCustomToast(
                context,
                '❌ Failed to save DG data to server. You can continue with local data.',
              );
              ...
              print(
                'DG Screen: Reset _hasPostedDGData flag to false after error',
              );
            } else {
              print(
                'DG Screen: AssetAuditPostError received but not for DG data, ignoring...',
              );
            }
          }
        },
                                          ...
                                          try {
                                            ...
                                            if (await photoFile.exists()) {
                                              ...
                                              if (photoId != null) {
                                                setState(() {
                                                  dgPhotoId =
                                                      photoId; // Store the photoId for DG
                                                });
                                                print(
                                                  'DG Screen: DG Photo uploaded successfully, photoId: $photoId',
                                                );
                                              }
                                            }
                                          } catch (e) {
                                            print(
                                              'DG Screen: Error uploading DG photo: $e',
                                            );
                                          }
                                        } else {
                                          setState(() {
                                          ...
                                          try {
                                            ...
                                            if (await photoFile.exists()) {
                                              ...
                                              if (photoId != null) {
                                                setState(() {
                                                  dgMakePhotoId =
                                                      photoId; // Store the photoId for DG Make
                                                });
                                                print(
                                                  'DG Screen: DG Make Photo uploaded successfully, photoId: $photoId',
                                                );
                                              }
                                            }
                                          } catch (e) {
                                            print(
                                              'DG Screen: Error uploading DG Make photo: $e',
                                            );
                                          }
                                        } else {
                                          setState(() {
                                          ...
                                          try {
                                            ...
                                            if (await photoFile.exists()) {
                                              ...
                                              if (photoId != null) {
                                                ...
                                                print(
                                                  'DG Screen: Photo uploaded successfully, photoId: $photoId',
                                                );
                                              }
                                            }
                                          } catch (e) {
                                            print(
                                              'DG Screen: Error uploading photo: $e',
                                            );
                                          }
                                        }
                                      },
                                ...
                                child: ArrowButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (savedCCTVItems.isNotEmpty) {
                                      try {
                                        print(
                                          'DG Screen: Attempting to post data before navigation...',
                                        );
                                        ...
                                        print(
                                          'DG Screen: Error posting data: $e',
                                        );
