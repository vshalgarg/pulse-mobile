...
class InverterV2Screen extends StatefulWidget {
  ...
  @override
  State<InverterV2Screen> createState() => _InverterV2ScreenState();
}

class _InverterV2ScreenState extends State<InverterV2Screen> {
  final String _screenName = 'Invertor';
