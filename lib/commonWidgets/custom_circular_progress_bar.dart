...
class CustomSimpleCircularProgressBar extends StatefulWidget {
  ...
  const CustomSimpleCircularProgressBar({
    Key? key,
    this.size = 100,
    this.maxValue = 100,
    this.startAngle = 0,
  ...
  @override
  _CustomSimpleCircularProgressBarState createState() => _CustomSimpleCircularProgressBarState();
}

class _CustomSimpleCircularProgressBarState extends State<CustomSimpleCircularProgressBar>
  ...
  void initState() {
    ...
    // Create animation.
    final animationDuration = (widget.animationDuration < 0) ? 0 : widget.animationDuration;
      ...
      builder: (BuildContext context, double value, Widget? child) {
        ...
        return AnimatedBuilder(
          ...
          builder: (context, snapshot) {
            ...
            final isFullProgress = widget.mergeMode & (animationController.value == animationController.upperBound);
