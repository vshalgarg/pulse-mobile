...
class CustomTextFormFieldWidgetTwo extends StatelessWidget {
  ...
  const CustomTextFormFieldWidgetTwo({
    this.inputBorder,
    this.initialValue,
    this.controller,
    this.labelText,
  ...
  Widget build(BuildContext context) {
    TextStyle defaultStyle = TextStyle(
        color: (autoFocus ?? false) ? AppColors.reachBlackColor : AppColors.textGreyColor,
