...
class VideoRecorderDemoWidget extends StatefulWidget {
  final List<CameraDescription> cameras;

  VideoRecorderDemoWidget({Key? key, required this.cameras}) : super(key: key);

  @override
  State<VideoRecorderDemoWidget> createState() {
    return _VideoRecorderDemoWidgetState();
  }
}
...
class _VideoRecorderDemoWidgetState extends State<VideoRecorderDemoWidget>
