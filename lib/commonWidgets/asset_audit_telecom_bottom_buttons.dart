    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: ArrowButton(
              text: AssetAuditNavigationHelper.getTelecomPreviousScreenName(assetAuditData, screenName),
              isLeftArrow: true,
              backgroundColor: AppColors.buttonColorBackBg,
              textColor: AppColors.buttonColorTextBg,
              onPressed: () {
                AssetAuditNavigationHelper.navigateToPreviousTelecomScreen(context, assetAuditData, screenName, siteAuditSchId, siteType, auditSchId);
              },
            ),
          ),
          getWidth(14),
          Expanded(
            child: ArrowButton(
              text: AssetAuditNavigationHelper.getTelecomNextScreenName(assetAuditData, screenName),
              isLeftArrow: false,
